...
public class HexGridChunk : MonoBehaviour
{
    ...
    private void TriangulateWithoutRiver(HexCell cell, Vector3 center, EdgeVertices e, HexDirection direction)
    {
    ...
    void TriangulateBoundaryTriangle(Vector3 begin,
                                     Color   beginWeights,
                                     Vector3 left,
                                     Color   leftWeights,
                                     Vector3 boundary,
        ...
        if (hasRiver) {
            ...
            if (!cell.IsUnderwater) {
                if (!neighbor.IsUnderwater) {
                    ...
                    TriangulateWaterfallInWater(e1.v2,
                                                e1.v4,
                                                e2.v2,
                                                e2.v4,
                                                cell.RiverSurfaceY,
                ...
                TriangulateWaterfallInWater(e2.v4,
                                            e2.v2,
                                            e1.v4,
                                            e1.v2,
                                            neighbor.RiverSurfaceY,
    ...
    void TriangulateCornerTerraces(Vector3 begin,
                                   HexCell beginCell,
                                   Vector3 left,
                                   HexCell leftCell,
                                   Vector3 right,
    ...
    void TriangulateCornerTerracesCliff(Vector3 begin,
                                        HexCell beginCell,
                                        Vector3 left,
                                        HexCell leftCell,
                                        Vector3 right,
    ...
    void TriangulateCornerCliffTerraces(Vector3 begin,
                                        HexCell beginCell,
                                        Vector3 left,
                                        HexCell leftCell,
                                        Vector3 right,
    ...
    {
        EdgeVertices m =
            new EdgeVertices(Vector3.Lerp(center, e.v1, 0.5f),
                             Vector3.Lerp(center, e.v5, 0.5f)) { v3 = { y = e.v3.y } };
    ...
    void TriangulateRiverQuad(Vector3 v1,
                              Vector3 v2,
                              Vector3 v3,
                              Vector3 v4,
                              float   y,
    ...
    void TriangulateRoad(Vector3      center,
                         Vector3      mL,
                         Vector3      mR,
                         EdgeVertices e,
    ...
    void TriangulateRoadSegment(Vector3 v1,
                                Vector3 v2,
                                Vector3 v3,
                                Vector3 v4,
                                Vector3 v5,
    ...
    void TriangulateWaterfallInWater(Vector3 v1,
                                     Vector3 v2,
                                     Vector3 v3,
                                     Vector3 v4,
                                     float   y1,
