...
public class DeferredFogEffect : MonoBehaviour
{
    ...
    [NonSerialized] Material  fogMaterial;
    [NonSerialized] Camera    deferredCamera;
    [NonSerialized] Vector3[] frustumCorners;
    [NonSerialized] Vector4[] vectorArray;
    ...
    void OnRenderImage(RenderTexture source, RenderTexture destination)
    {
        ...
        deferredCamera.CalculateFrustumCorners(new Rect(0f, 0f, 1f, 1f),
