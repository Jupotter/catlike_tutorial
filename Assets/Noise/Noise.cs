...
namespace Noise
{
    ...
    {
        public delegate NoiseSample Method(Vector3 point, float frequency);
        ...
        public static Method[] valueMethods = {Value1D, Value2D, Value3D};

        public static Method[] perlinMethods = {Perlin1D, Perlin2D, Perlin3D};

        public static Method[][] noiseMethods = {valueMethods, perlinMethods};
        ...
        private static Vector2[] gradients2D =
        {
            ...
            new Vector2(1f, 1f).normalized, new Vector2(-1f, 1f).normalized, new Vector2(1f, -1f).normalized,
        ...
        public static NoiseSample Sum(Method method, Vector3 point, float frequency, int octaves, float lacunarity,
                                      float  persistence)
        {
