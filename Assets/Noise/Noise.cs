...
namespace Noise
{
    ...
    {
        public delegate float Method(Vector3 point, float frequency);
        ...
        public static Method[] valueMethods =
        {
            Value1D,
            Value2D,
            Value3D
        ...
        public static Method[] perlinMethods =
        {
            Perlin1D,
            Perlin2D,
            Perlin3D
        ...
        public static Method[][] noiseMethods =
        {
            valueMethods,
            perlinMethods
        };
        ...
        public static float Sum(Method method, Vector3 point, float frequency, int octaves, float lacunarity,
                                float  persistence)
        {
